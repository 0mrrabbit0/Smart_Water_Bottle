/**
 * @file    bsp_oled_font.h
 * @brief   OLED font data - 6x8 and 8x16 ASCII fonts
 */

#ifndef __BSP_OLED_FONT_H__
#define __BSP_OLED_FONT_H__

#include <stdint.h>

/* 6x8 ASCII font, characters 0x20-0x7F (96 chars), 6 bytes each */
...
/* 8x16 ASCII font, characters 0x20-0x7F (96 chars), 16 bytes each
   Format: upper 8 bytes (page n) + lower 8 bytes (page n+1) */
